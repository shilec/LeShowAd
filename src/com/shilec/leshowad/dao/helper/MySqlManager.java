...
public class MySqlManager {
	...
	final StringBuilder T_USER = new StringBuilder()
			...
			.append("t_user(")
			.append("wx_id varchar(256),")
			.append("wx_user_name varchar(64),")
			.append("wx_location varchar(256),")
			.append("balance float,")
			.append("id integer not null primary key auto_increment")
			.append(")");
	
	final StringBuilder T_SHARE_MAP = new StringBuilder()
			.append("CREATE TABLE IF NOT EXISTS ")
			.append("t_share_map(")
			.append("id integer not null primary key auto_increment,")
			.append("wx_id varchar(256),")
			.append("red_packet_id integer,")
			.append("income float,")
			.append("shared_wx_id varchar(256),")
			.append("open_count int")
			.append(")");
	
	final StringBuilder T_RED_PACKET = new StringBuilder()
			.append("CREATE TABLE IF NOT EXISTS ")
			.append("t_red_packet(")
			.append("id integer not null primary key auto_increment,")
			.append("locations varchar(256),")
			.append("all_money float,")
			.append("packet_count int,")
			.append("income_count int,")
			.append("leave_count int,")
			.append("leave_money float,")
			.append("ad_id int,")
	...
	public <T> IDatabaseHelper<T> getHelper(Class<T> cls) {
		...
		try {
			return (IDatabaseHelper<T>) dao.newInstance();
